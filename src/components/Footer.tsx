  ...
  >
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 1 }}>
      ...
      <Box sx={{ display: 'flex', gap: 3, mb: 2 }}>
        ...
        <Link href="#" underline="none" sx={{ color: '#fff', fontWeight: 500, fontSize: 16, '&:hover': { color: '#1db954' } }}>Terms</Link>
        <Link href="#" underline="none" sx={{ color: '#fff', fontWeight: 500, fontSize: 16, '&:hover': { color: '#1db954' } }}>Privacy</Link>
        <Link href="#" underline="none" sx={{ color: '#fff', fontWeight: 500, fontSize: 16, '&:hover': { color: '#1db954' } }}>Contact</Link>
      </Box>
